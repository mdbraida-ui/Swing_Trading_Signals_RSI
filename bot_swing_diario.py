...
def rutina_apertura(iol_client):
    ...
    print(f"[apertura] {resumen}")  # visible en el log de GitHub Actions
...
def rutina_cierre(iol_client):
    ...
    # --- Registrar una fila de "Resumen" con el estado de hoy (1 vez
    #     por día, acá en cierre -- no en monitoreo, para no generar
    #     ~78 filas diarias). Esta serie histórica es la que alimenta el
    ...
    print(f"[cierre] {resumen}")  # visible en el log de GitHub Actions
