...
class IOLClient:
    ...
    def comprar_mercado(self, ticker: str, cantidad: int, mercado: str = "bCBA") -> dict:
        ...
        *** CAMPOS NO 100% CONFIRMADOS *** -- probar primero en el sandbox
        de IOL (api-sandbox.invertironline.com) y ajustar si la respuesta
        da error 400 detallando el campo incorrecto.
        """
        simbolo = ticker.replace(".BA", "")
        body = {
            "mercado": mercado,
            "simbolo": simbolo,
            "cantidad": cantidad,
            "precio": 0,          # 0 = a precio de mercado en la mayoría de brokers con esta convención
            "plazo": "t0",        # Contado Inmediato
            "validez": None,      # orden del día
            "tipoOrden": "mercado",
        }
