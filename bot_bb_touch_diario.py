    ...
    try:
        ...
        for fila in tickers_planilla_completa:
            ...
            indicadores_cierre[ticker] = {
                ...
                "senal_pendiente": toco_banda_reciente and not bool(ultimo["senal_confirmada"]),
                "senal_confirmada": bool(ultimo["senal_confirmada"]),
                "en_cooldown": ticker in cooldown and cooldown[ticker] >= hoy,
            }
        sheets.actualizar_indicadores(sheet, indicadores_cierre)
    except Exception as e:
